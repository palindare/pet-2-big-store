  ...
  return (
    <>
      <div className={styles.container_conditioners}>
        {state.map(({ img, name, price, bonus, span },index) => {
          return (
            <div
            key={index}
            ...
            >
              <div className={styles.marking_conditioners}>
                <div className={styles.container_info}>
                  <div style={{height: !span ? "136px" : "100%"}} className={styles.container_img}>
                  ...
                  <div className={!span ? styles.container_price : styles.container_price_span}>{price}</div>
